...
int main() {
    ...
    float feedbackAmount = 0.5f;  // Ajuste de feedback
    ...
    // Inicializa o reverb com um valor de feedback
    ...
    // Libera a memória dos canais de entrada
    free(leftChannel);
    free(rightChannel);

    printf("Arquivo reverb_output_stereo.wav criado com sucesso!\n");
    return 0;
}
