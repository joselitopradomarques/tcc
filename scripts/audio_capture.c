...
#define PCM_CAPTURE_FILE "captured_audio.wav"
#define CAPTURE_TIME 60  // Tempo de captura em segundos
#define SAMPLE_RATE 44100  // Taxa de amostragem (8000 Hz)
...
int main() {
    ...
    snd_pcm_format_t format = SND_PCM_FORMAT_S16_LE;  // Formato S16_LE
    unsigned int rate = SAMPLE_RATE;
    int channels = 2;  // Número de canais (Estéreo)
    ...
    short *buffer = (short *) malloc(buffer_size * channels * sizeof(short)); // 16 bits por amostra (S16_LE)
